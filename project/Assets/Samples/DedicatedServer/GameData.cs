...
namespace Matchplay.Shared
{
    ...
    public class MatchplayUser
    {
        ...
        {
            get => Data.userGamePreferences.gamePassword;
            set => Data.userGamePreferences.gamePassword = value;
        }
    ...
    {
        public static string GetName(string tempId)
        {
            // Generate a random name based on the tempId
            // This is a placeholder implementation, you can replace it with a more sophisticated name generation logic.
            return $"Player_FIXME-NameGenerator-gameData";
        }
    }
    ...
    {
        // Sammoh, this is the data that will be used to set up the game.
        // It includes the map, game mode, game queue, and password.
        ...
        public override string ToString()
        {
            ...
            sb.AppendLine($"- password: {gamePassword}");
            return sb.ToString();
        }
